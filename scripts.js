...
(() => {
  ...
  (() => {
    ...
    function loop() {
      ...
      if (!deleting) {
        ci++;
        if (ci > phrase.length) { deleting = true; setTimeout(loop, 2400); return; }
        setTimeout(loop, 36 + Math.random() * 24);
      } else {
        ci--;
        if (ci < 0) {
          deleting = false;
          ...
          applyScene(pi);
          if (canvasAPI) canvasAPI.switchScene(pi);
          setTimeout(loop, 320);
          return;
        }
        setTimeout(loop, 18);
  ...
  /* ─────────────────────────────────────────────────────────────
     ...
     Optimized: pauses when offscreen
     ───────────────────────────────────────────────────────────── */
  let canvasAPI = null;
